          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="text-white bg-green-700  rounded-xl w-[13%] hover:shadow-lg disabled:opacity-80"
              >
              ...
              formData.imageUrls.map((url, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-1 text-white bg-red-600 border w-[11%] rounded-lg hover:opacity-75"
                  >
                    Delete
                  </button>
                </div>
            ...
            <div className='flex gap-3'>
              <button
                ...
                className="p-2 bg-green-700 text-white border rounded-lg mt-3 hover:opacity-75 w-full disabled:opacity-80"
              >
                {loading ? "Updating..." : "Submit"}
              </button>

              <button 
              onClick={goBack} className="p-2 bg-blue-600 text-white border w-[20%] rounded-lg mt-3 hover:opacity-75  disabled:opacity-80">
                Back
              </button>
            </div>
